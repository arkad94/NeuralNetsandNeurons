...
def create_prompt(CMD, tag, SPINS):
    cmd_templates = {
        ...
        "A Story": "Write a story in japanese length of which is between 3000-4000 characters, followed with a summary in English and in the end under the header difficult words tabulate difficult Japanese words and their english translations. Japanese Story has heading as title, the english summary which follows the Japanese story has title English Summary, and the difficult words are under the header difficult words as (日本語・English Pronounciation) devation from the format would be harmful",
